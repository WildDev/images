package com.wilddev.image.controllers;

import com.wilddev.image.sdk.controllers.AbstractController;
import com.wilddev.image.sdk.controllers.responses.ID;
import com.wilddev.image.sdk.mappers.MultiValueMapper;
import com.wilddev.image.validators.ImageUploadRequestValidator;
...
import com.wilddev.image.controllers.requests.*;
...
public class ImageController extends AbstractController {
    ...
    public ResponseEntity<?> add(@Valid @RequestBody ExternalImageAddRequest request, Errors errors) {
        ...
        final String imageId = imageService.add(request.getUrl(), request.getMultiSize()).getId().toString();
    ...
    public ResponseEntity<?> upload(@Valid ImageUploadRequest request, Errors errors) throws Exception {
        ...
        final String imageId = imageService.upload(request.getFile(), request.getMultiSize()).toString();
