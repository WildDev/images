...
import com.wilddev.image.services.editors.tools.*;
...
public class ImageCropEffect extends AbstractImageCustomSizeEffect<CropSize> {
    ...
    @LogTimeExecuted("ImageCropEffect#calcTargetDimension(bufferedImage, targetDimension)")
    @Override
    ...
    @LogTimeExecuted("ImageCropEffect#accept(sourceImage, targetDimension)")
    @Override
